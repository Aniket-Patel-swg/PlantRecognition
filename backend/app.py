...
# @app.route('/get-recognized-plant', methods=['GET'])
# def get_recognized_plant():
...
#     recognized_plant = predict_image(file_path)
#     print(recognized_plant)
#     return jsonify({'plantName': recognized_plant})
...
#         return jsonify({'message': 'Image uploaded and processed successfully', 'plantName': prediction})
